    ...
    public class ProductDAL : _BaseDAL, IProductDAL
    {
        ...
        public int Add(Product data)
        {
            ...
            using (SqlConnection cn = OpenConnection())
            {
                ...
                cmd.CommandText = @"INSERT INTO Products(ProductName,Price,Photo,Unit,CategoryID,SupplierID)
                                    VALUES(@ProductName,@Price,@Photo,@Unit,@CategoryID,@SupplierID);
        ...
        public long AddPhoto(ProductPhoto data)
        {
            ...
            {
                SqlCommand cmd = new SqlCommand();
                cmd.CommandText = @"INSERT INTO ProductPhotos(Photo,Description,DisplayOrder,IsHidden,ProductID)
                                    VALUES(@Photo,@Description,@DisplayOrder,@IsHidden,@ProductID);
                                    SELECT SCOPE_IDENTITY()";
                cmd.CommandType = CommandType.Text;
                cmd.Connection = cn;
                cmd.Parameters.AddWithValue("@Photo", data.Photo);
