        ...
        public bool InUsed(int id)
        {
            ...
            using (SqlConnection cn = OpenConnection())
            {
                ...
                cmd.CommandText = @"SELECT CASE 
                                                WHEN EXISTS(SELECT * FROM Products WHERE CustomerID = @CustomerID) THEN 1 
                                                ELSE 0 
                                            END";
                cmd.CommandType = CommandType.Text;
                cmd.Connection = cn;
        ...
        public bool Update(Customer data)
        {
            ...
            using (SqlConnection cn = OpenConnection())
            {
                ...
                cmd.CommandText = @"UPDATE Customers
                                    SET CustomerName = @CustomerName, ContactName = @ContactName, Address = @Address, City = @City, PostalCode = @PostalCode, Country = @Country, Email = @Email, Password = @Password
